...
@check_structure_equal('disloc_AlN_edge_cut011.xsf')
...
@check_structure_equal('disloc_AlN_screw_cut010.xsf')
...
@check_structure_equal('disloc_AlN_screw_cut010_neg.xsf')
...
def aln_cell():
    ...
    return cell.repeat((8, 5, 5), explode=True)